...
func _1646659233_add_address_to_dapp_permisssionUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1646659233_add_address_to_dapp_permisssion.up.sql", size: 700, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1646841105_add_emoji_accountUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1646841105_add_emoji_account.up.sql", size: 96, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647278782_display_nameUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647278782_display_name.up.sql", size: 110, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647862838_reset_last_backupUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647862838_reset_last_backup.up.sql", size: 37, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647871652_add_settings_sync_clock_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647871652_add_settings_sync_clock_table.up.sql", size: 1044, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647880168_add_torrent_configUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647880168_add_torrent_config.up.sql", size: 211, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647882837_add_communities_settings_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647882837_add_communities_settings_table.up.sql", size: 206, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1647956635_add_waku_messages_tableUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1647956635_add_waku_messages_table.up.sql", size: 266, mode: os.FileMode(0644), modTime: time.Unix(1648730563, 0)}
...
func _1648554928_network_testUpSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "1648554928_network_test.up.sql", size: 132, mode: os.FileMode(0644), modTime: time.Unix(1648730564, 0)}
