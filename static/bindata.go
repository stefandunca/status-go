...
func emojisTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "emojis.txt", size: 28134, mode: os.FileMode(0644), modTime: time.Unix(1648730564, 0)}
...
func ConfigReadmeMd() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/README.md", size: 3031, mode: os.FileMode(0644), modTime: time.Unix(1648220557, 0)}
...
func ConfigCliFleetStatusProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-status.prod.json", size: 1920, mode: os.FileMode(0644), modTime: time.Unix(1648730564, 0)}
...
func ConfigCliFleetStatusTestJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-status.test.json", size: 937, mode: os.FileMode(0644), modTime: time.Unix(1648220557, 0)}
