...
func emojisTxt() (*asset, error) {
	...
	info := bindataFileInfo{name: "emojis.txt", size: 28134, mode: os.FileMode(0644), modTime: time.Unix(1648220557, 0)}
...
func ConfigCliFleetStatusProdJson() (*asset, error) {
	...
	info := bindataFileInfo{name: "../config/cli/fleet-status.prod.json", size: 1920, mode: os.FileMode(0644), modTime: time.Unix(1648220557, 0)}
