...
type SyncSavedAddress struct {
	...
	Removed              bool     `protobuf:"varint,5,opt,name=removed,proto3" json:"removed,omitempty"`
	SyncClock            uint64   `protobuf:"varint,6,opt,name=sync_clock,json=syncClock,proto3" json:"sync_clock,omitempty"`
	UpdateClock          int64    `protobuf:"varint,7,opt,name=update_clock,json=updateClock,proto3" json:"update_clock,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *SyncSavedAddress) GetSyncClock() uint64 {
	if m != nil {
		return m.SyncClock
	}
	return 0
...
func (m *SyncSavedAddress) GetUpdateClock() int64 {
	if m != nil {
...
var fileDescriptor_d61ab7221f0b5518 = []byte{
	...
	,
}
