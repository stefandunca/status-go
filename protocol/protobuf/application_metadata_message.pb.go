...
const (
	...
	ApplicationMetadataMessage_CONTACT_VERIFICATION_TRUSTED            ApplicationMetadataMessage_Type = 49
)
...
var ApplicationMetadataMessage_Type_name = map[int32]string{
	...
	49: "CONTACT_VERIFICATION_TRUSTED",
}
...
var ApplicationMetadataMessage_Type_value = map[string]int32{
	...
	"CONTACT_VERIFICATION_TRUSTED":            49,
}
...
var fileDescriptor_ad09a6406fcf24c7 = []byte{
	...
	,
}
